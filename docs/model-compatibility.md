...
| **Zeta 2.1**, 4-bit MLX-LM                                           | The MLX conversion loads successfully and reproduces the official upstream multi-region sample. A direct plain Seed FIM probe did not produce a valid completion.                                                       | Downloadable in Reticle MLX as a Next Edit preview. Do not activate it as ordinary FIM; it requires Zeta 2.1's numbered editable regions, cursor marker, and edit-history-aware response parser.                |
